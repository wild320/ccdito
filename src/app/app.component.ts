...
export class AppComponent implements OnInit {
    ...
    ngOnInit(): void {
        ...
        this.metaTagService.addTags([
            ...
            { property: 'og:url', content: `${baseHref}` },
            { property: 'og:image', content: `${baseHref}/assets/configuracion/LOGO2.png` },
            ...
            { name: 'twitter:image', content: `${baseHref}/assets/configuracion/LOGO2.png` },
          ]);
    }
